...
function LoginPage() {
    ...
    const { isLoaded, signIn, setActive } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$clerk$2d$react$2f$dist$2f$chunk$2d$GS2PUW25$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useSignIn"])();
    ...
    const redirectByRole = async (session)=>{
        ...
        const role = session?.user?.publicMetadata?.role || "employee";
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            // ✅ Step 2: Complete sign-in if needed
...
_s(LoginPage, "Uzh32vwcDhNNu8Tcs5Ba4VixS8g=", false, function() {
    return [
...
//# sourceMappingURL=_a947580d._.js.map